...
#include "xxxyDist2.h"
#include "crosstab.h"
class a2de2: public IncrementalLearner {
public:

	a2de2(char* const *& argv, char* const * end);
	...
	/**
	 * Calculates the weight for wa2de2
	 */
	void finalisePass();
...
private:
	...
	bool weighted; 			///< true  if  using weighted a2de2
	bool avg;  				///< true if using averaged mutual information as weight

	bool selected;   			///< true iif using selective a2de2
