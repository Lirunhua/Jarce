...
class kdbCondDisc2 :  public kdb
{
public:
  kdbCondDisc2();
  kdbCondDisc2(char*const*& argv, char*const* end);
  ~kdbCondDisc2(void);
  ...
  void leafSearch(dtNode *next, const CategoricalAttribute na, std::vector<CatValue> parentValues); ///< depth-first the dtTree of a numeric attribute to discretise the values on the leaves.
