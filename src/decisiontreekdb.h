...
class decisiontreekdb : public IncrementalLearner {
public:
    decisiontreekdb();
    decisiontreekdb(char*const*& argv, char*const* end);
    ~decisiontreekdb(void);
...
protected:
    ...
    unsigned int numofAttvalue;
    CategoricalAttribute root;
    CategoricalAttribute root_loc;
    ...
    std::vector<std::vector<std::vector<CategoricalAttribute> > > parents_; //genernal;
    std::vector<std::vector<CategoricalAttribute> > parents_loc; 
