...
public:
    ...
    virtual void getNoCatAtts_(unsigned int &NoCatAtt) {};

    virtual void getStructure(std::vector<std::vector<CategoricalAttribute> > &parents, std::vector<CategoricalAttribute> &order) {};
    virtual void getStructure_kdb(std::vector<std::vector<CategoricalAttribute> > &parents) {};

    virtual void chang_parents(std::vector<std::vector<CategoricalAttribute> > &parents_change){};
    ...
    }; ///< print details of the classifier that has been created
