 ...
 *
 *
 * @author Shenglei Cheng and Ana M Martinez (anam.martinez@monash.edu) 
 */
class sampler : public IncrementalLearner
{
public:
  
  /**
   * @param argv Options for the sampler classifier
   * @param argc Number of options for sampler
   */
  sampler(char*const*& argv, char*const* end);
